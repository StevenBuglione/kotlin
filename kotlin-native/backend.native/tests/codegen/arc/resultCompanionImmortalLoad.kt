...
// OPT: alloca %struct.ObjHeader*, i32 5
// OPT-NOT: @"kfun:kotlin.Result#<get-$companion>#static(){}kotlin.Result.Companion"
// OPT: [[COMPANION:%[-a-zA-Z$._0-9]+]] = load %struct.ObjHeader*, %struct.ObjHeader** @"kvar:kotlin.Result.$companion#internal"
// OPT-NOT: call void @Update{{Stack|Return}}Ref
// OPT: {{call|invoke}} %struct.ObjHeader* @"kfun:kotlin#<Int-box>
...
// NOOPT-LABEL: define internal %struct.ObjHeader* @"kfun:immediate#internal"
// NOOPT: @"kfun:kotlin.Result#<get-$companion>#static(){}kotlin.Result.Companion"
// NOOPT: ret %struct.ObjHeader*
...
// OPT: load %struct.ObjHeader*, %struct.ObjHeader** @"kvar:ResultLookalike.$companion#internal"
// OPT: ret %struct.ObjHeader*
