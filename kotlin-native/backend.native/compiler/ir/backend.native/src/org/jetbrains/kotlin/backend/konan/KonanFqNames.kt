...
object KonanFqNames {
    ...
    val arcPackageName = FqName("kotlin.native.arc")
    val arcWeak = arcPackageName.child(Name.identifier("ArcWeak"))
    val arcUnowned = arcPackageName.child(Name.identifier("ArcUnowned"))
    val arcDeinit = arcPackageName.child(Name.identifier("ArcDeinit"))
